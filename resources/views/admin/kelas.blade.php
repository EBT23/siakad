    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <div class="text-center">
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#tambahModal" class="btn btn-primary shadow-md mr-2">Add Kelas</a>
            </div>
                ...
                <tbody>
                    ...
                    @foreach ($kelas as $no => $k)
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">{{ $k->kelas }}</a>
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5"></div>
                            </td>
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#editModal1{{ $k->id }}" >
                                        <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                    </a>
                                     <!-- BEGIN: Edit Modal Content -->
                                     <div id="editModal1{{ $k->id }}" class="modal" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <!-- END: Modal Header -->
                                                <!-- BEGIN: Modal Body -->
                                                <form action="{{ route('kelas.edit', ['id' => $k->id]) }}" method="POST">
                                                    @csrf
                                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                    <div class="col-span-12 sm:col-span-lg">
                                                        <label for="kelas">Kelas</label>
                                                        <input id="kelas" value="{{ $k->kelas }}" name="kelas" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <!-- BEGIN: Modal Footer -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    ...
                                    <form action="hapus_kelas/{{ $k->id }}" method="POST">
                                        @method('DELETE')
                                        @csrf
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                        <div class="col-span-12 sm:col-span-lg">
                                                            ...
                                                            aria-describedby="kelas" required>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Cancel</button>
